...
{   
    public class AtomCreationTests
    {
        ...
        public async void FuncWithoutInput()
        {
            ...
            Assert.Equal(1, await Atom.Func(() => _signature.Func()).Invoker().Charge());
        }
        ...
        public async void FuncWithInput()
        {
            ...
            Assert.Equal(2, await Atom.Func<int, int>(i => _signature.Func(i.Input)).Receiver().Listen<int>().Charge(1));
        }
        ...
        public async void AsyncFuncWithoutInput()
        {
            ...
            Assert.Equal(1, await Atom.Func(() => _signature.AsyncFunc()).Invoker().Charge());
        }
        ...
        public async void AsyncFuncWithInput()
        {
            ...
            Assert.Equal(2, await Atom.Func<int, int>(i => _signature.AsyncFunc(i.Input)).Receiver().Listen<int>().Charge(1));
        }

        [Fact]
        public async void ActionWithoutInput()
        {
            await Atom.Action(() => _signature.Action()).Invoker().Charge();
        ...
        {
            await Atom.Action<int>(i => _signature.Action(i.Input)).Receiver().Listen<int>().Charge(1);
        ...
        public async void AsyncAction()
        {
            ...
            await Atom.Action(() => _signature.AsyncAction()).Invoker().Charge();
...
#pragma warning restore 4014
        ...
        public async void AsyncActionWithInput()
        {
            ...
            await Atom.Action<int>(i => _signature.AsyncAction(i.Input)).Receiver().Listen<int>().Charge(1);
