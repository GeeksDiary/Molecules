...
&$nuget pack -IncludeReferencedProjects Extensions/Dependable.Extensions.Dependencies.Autofac/Dependable.Extensions.Dependencies.Autofac.csproj -OutputDirectory .build
&$nuget pack -Symbols Extensions/Dependable.Extensions.Dependencies.Autofac/Dependable.Extensions.Dependencies.Autofac.csproj -OutputDirectory .build